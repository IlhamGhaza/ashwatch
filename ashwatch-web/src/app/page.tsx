        ...
        <section className="relative mx-auto max-w-7xl px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link
                href="/volcanoes"
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-800 bg-slate-900/80 px-6 py-3.5 text-base font-semibold text-slate-200 backdrop-blur-sm transition hover:bg-slate-850 hover:text-white sm:w-auto"
              >
          ...
          {/* Active Advisories Live Ticker Cards */}
          <div className="mt-16">
              ...
              {data.deduplicated.slice(0, 4).map((adv) => {
                ...
                return (
                  <Link
                    ...
                    className="group relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-lg backdrop-blur-sm transition hover:border-red-500/50 hover:bg-slate-900/90 hover:-translate-y-1"
                  >
                    <div
        ...
        <section className="border-t border-slate-900 bg-slate-900/30 py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-4">
              <div className="relative rounded-2xl border border-slate-800 bg-slate-900/60 p-6 text-center">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-red-500/10 text-red-400 mb-4 font-bold text-lg">
                  1
                </div>
